...
$(function () {
    $("#thumbnail img").on("mouseleave", removePreview);
    $("#thumbnail img").on("mousemove", movePreview);
    
    $('#thumbnail img').on('mouseover', function (e) {
    ...
    function removePreview() {
        //remove the dynamci elemnt and the gray class
